...
export default function ImageCard(props: ImageCardProps) {
  const IMAGE_URL = `${AGGREGATOR_URL}/v1/blobs/by-quilt-patch-id/${props.patchId}`
  ...
  return (
    <div className="w-[480px] h-full max-h-[158px] min-h-[158px] bg-[#0C0F1D] rounded-2xl border-2 border-[#97F0E533] flex flex-row items-center justify-center gap-2">
      <div className="w-[142px] h-[142px] relative rounded-lg overflow-hidden">
        {hasError ? (
          ...
          <Image
            ...
            onLoad={() => {
              console.log(
                `[ImageCard ${props.blobId}] Image loaded successfully`
              )
            }}
            onError={e => {
              console.error(
                `[ImageCard ${props.blobId}] Image failed to load:`,
                e
              )
              setHasError(true)
            }}
      ...
      <div className="h-[142px] flex flex-col items-center justify-between">
        <div className="w-[314px] h-[34px] bg-[#97F0E514] flex flex-row items-center justify-between rounded-t-md px-2">
        ...
        <div className="w-[314px] h-[34px] bg-[#97F0E514] flex flex-row items-center justify-between rounded-b-md px-2">
          <span className="text-[#F7F7F7] text-sm font-medium w-[157px] text-left">
            Download Link
          </span>
          <div className="w-[157px] overflow-hidden flex items-center">
