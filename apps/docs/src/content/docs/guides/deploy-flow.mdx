  ...
  return (
    <div className="deployment-flow">
      ...
      <div className="deploy-steps">
        ...
        >
          {currentStep > DeploySteps.Prepared ? '✅ Written' : '2. Write Resources'}
        </button>
        ...
        >
          {currentStep > DeploySteps.Written ? '✅ Certified' : '3. Certify Resources'}
        </button>
        ...
        >
          {currentStep > DeploySteps.Certified ? '✅ Deployed' : '4. Write Site'}
        </button>
      </div>
